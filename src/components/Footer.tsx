          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
            ...
            <div className="hidden sm:block">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/mugabuyisenga.gilbert" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                  <Facebook className="h-5 w-5 text-primary-foreground" />
                </a>
                <a href="https://www.linkedin.com/in/gilbert-mugabuyisenga-25b069144/" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                  <Linkedin className="h-5 w-5 text-primary-foreground" />
                </a>
                <a href="https://x.com/gilbert_mugabo" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a 
                    href="mailto:skylineconseng@gmail.com"
                    className="text-secondary-foreground/80 hover:text-primary transition-colors duration-300"
                  >
                    skylineconseng@gmail.com
                  </a>
                </div>
