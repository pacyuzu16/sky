      ...
      <div className="container mx-auto px-6">
        ...
        <div className="bg-background rounded-2xl p-8 lg:p-12 shadow-construction">
          ...
          <div className="text-center mt-8">
            <a
              href="/contact"
              className="inline-block bg-gradient-primary text-primary-foreground shadow-elegant hover:shadow-lg transition-all duration-300 transform hover:scale-105 px-8 py-4 rounded-lg font-semibold"
            >
              Partner With Us
            </a>
          </div>
